...
public interface IBundesLiga<T extends IMannschaft<? extends FussballSpieler>> {
     ...
     * (herzustellen über bundesliga.generic2.IBundesLiga#sortMannschaften()
     *
     ...
     * <p>
     * Ruft vorher bundesliga.generic.IBundesLiga#sortMannschaften()
     *
     ...
     * <p>
     * Ruft vorher bundesliga.generic2.IBundesLiga#sortMannschaften() auf!
     *
